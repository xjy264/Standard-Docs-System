...
public record DocNodeRequest(
    ...
    public DocNodeRequest(Long sectionDeptId,
        ...
        this(sectionDeptId, parentId, nodeName, sortOrder, targetParentId, attachmentEnabled,
                contentHtml, fileType, null, businessType, submitterMode, requirements, null, null, null, null);
    }
    ...
    public DocNodeRequest(Long sectionDeptId,
                          ...
                          String fileType) {
        this(sectionDeptId, parentId, nodeName, sortOrder, targetParentId, attachmentEnabled,
                contentHtml, fileType, null, null, null, null, null, null, null, null);
    }
    ...
    public DocNodeRequest(Long sectionDeptId,
                          ...
                          Integer docYear) {
        this(sectionDeptId, parentId, nodeName, sortOrder, targetParentId, attachmentEnabled,
                contentHtml, fileType, docYear, null, null, null, null, null, null, null);
    }
    ...
    public DocNodeRequest(Long sectionDeptId,
        ...
        this(sectionDeptId, parentId, nodeName, sortOrder, targetParentId, attachmentEnabled, contentHtml, fileType,
                docYear, businessType, submitterMode, requirements, null, null, null, null);
    }
    ...
    public DocNodeRequest(Long sectionDeptId,
                          ...
                          Boolean showUploadProgress) {
        this(sectionDeptId, parentId, nodeName, sortOrder, targetParentId, attachmentEnabled, contentHtml, fileType,
                docYear, businessType, submitterMode, null, null, null, null, showUploadProgress);
    }
    ...
    public DocNodeRequest(Long sectionDeptId,
                          ...
                          List<Long> visibleWorkshopIds) {
        this(sectionDeptId, parentId, nodeName, sortOrder, targetParentId, attachmentEnabled, contentHtml, fileType,
                docYear, businessType, submitterMode, requirements, uploadDeadline, workshopUploadEnabled, visibleWorkshopIds, null);
    }
}
